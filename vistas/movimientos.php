...
<head>
    ...
    <title>Movimientos :: <?php echo SERVEREMPRESA;?></title>
    ...
    <form class="form-inline" id="form_main">
		  ...
		  <div class="form-group mx-sm-1 mb-2">
			<div class="input-group">				
				...
				<input type="date" required id="fechai" name="fechai" style="width:160px;" value="<?php echo date ("Y-m-d");?>" class="form-control" data-toggle="tooltip" data-placement="top" title="Fecha Inicio">
			</div>
		  </div>	
		  <div class="form-group mx-sm-1 mb-2">
			<div class="input-group">				
				...
				<input type="date" required id="fechaf" name="fechaf" style="width:160px;" value="<?php echo date ("Y-m-d");?>" class="form-control" data-toggle="tooltip" data-placement="top" title="Fecha Fin">
			</div>
		  </div>
		  <button type="submit" class="btn btn-info mb-2 mr-1" data-toggle="tooltip" data-placement="top" title="Registrar Movimientos" id="registrar"><i class="fas fa-plus-circle fa-lg"></i> Crear</button>
