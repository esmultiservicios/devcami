...
<div class="container-fluid">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb mt-2 mb-4">
			...
			<li class="breadcrumb-item active" id="acciones_cotizacion"><span id="label_acciones_cotizacion"></span></li>
		</ol>
	</nav>
		...
		<div class="card mb-4">
			<div class="card-body">
				<form class="form-inline" id="form_main_cotizacion">
					...
					<div class="form-group mx-sm-3 mb-1">
						<button class="btn btn-primary ml-1" type="submit" id="Crearcotizacion"><div class="sb-nav-link-icon" data-toggle="tooltip" data-placement="top" title="Crear Factura"></div><i class="fas fa-file-invoice fa-lg"></i> Crear Cotización</button>
					</div>  
				</form>          
			</div>
		</div>	
