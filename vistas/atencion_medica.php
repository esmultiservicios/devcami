            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div class="tab-content" id="myTabContent"><!-- INICIO TAB CONTENT-->
                <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab"><!-- INICIO TAB HOME-->
						...
						<div class="col-md-12 mb-3">
						  ...
						  <div class="input-group mb-3">
							  ...
							  <div class="input-group-append">				
								<a data-toggle="modal" href="#" class="btn btn-outline-success"><div class="sb-nav-link-icon"></div><i class="fas fa-plus-square fa-lg"></i></a>
							  </div>
						   </div>	
						</div>				
					</div>	
					...
					<div class="form-row">
						<div class="col-md-12 mb-3">
						  <label for="expedoente">Dirección</label>
						  <input type="text" name="procedencia" id="procedencia" placeholder="Dirección" readonly class="form-control"/>
						</div>			
					</div>		
				</div><!-- FIN TAB HOME-->
	  ...
	  <div class="form-group">
		<div class="dropdown show">
		  <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			 <i class="fas fa-plus-circle fa-lg"></i> Nuevo
		  </a>
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="#" id="nuevo_registro">Generar Atención</a>
