...
$comentario = mb_convert_case("Ingreso al Modulo de Preclinica", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Confirmación Cita :: <?php echo SERVEREMPRESA;?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Confirmación</li>
	</ol>
    ...
    <form class="form-inline" id="form_main">
      ...
      <div class="form-group mr-1">
         <input type="text" placeholder="Buscar por: Expediente, Nombre o Identidad" data-toggle="tooltip" data-placement="top" title="Buscar por: Expediente, Nombre, Apellido o Identidad" id="bs-regis" autofocus class="form-control" size="40"/>
      </div>
	...
	<?php 
		include "script.php"; 		
		include "../js/main.php"; 
		include "../js/myjava_preclinica.php"; 
